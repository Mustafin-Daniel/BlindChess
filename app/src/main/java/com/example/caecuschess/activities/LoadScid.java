...
public class LoadScid extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fileName = i.getStringExtra("com.example.caecuschess.pathname");
        resultSentBack = false;
        canceled = false;
        if ("com.example.caecuschess.loadScid".equals(action)) {
        ...
        } else if ("com.example.caecuschess.loadScidNextGame".equals(action) ||
                   "com.example.caecuschess.loadScidPrevGame".equals(action)) {
            boolean next = action.equals("com.example.caecuschess.loadScidNextGame");
