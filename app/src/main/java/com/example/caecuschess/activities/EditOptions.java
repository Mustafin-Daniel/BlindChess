...
import com.example.caecuschess.UCIOptions;
import com.example.caecuschess.Util;
import com.example.caecuschess.activities.util.FileBrowseUtil;
import com.example.caecuschess.databinding.EditoptionsBinding;
import com.example.caecuschess.databinding.UciOptionButtonBinding;
import com.example.caecuschess.databinding.UciOptionCheckBinding;
import com.example.caecuschess.databinding.UciOptionComboBinding;
import com.example.caecuschess.databinding.UciOptionSpinBinding;
import com.example.caecuschess.databinding.UciOptionStringBinding;
...
public class EditOptions extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent i = getIntent();
        uciOpts = (UCIOptions) i.getSerializableExtra("com.example.caecuschess.ucioptions");
        workDir = (String) i.getSerializableExtra("com.example.caecuschess.workDir");
        hasBrowser = (Boolean) i.getSerializableExtra("com.example.caecuschess.localEngine");
        if (uciOpts != null) {
            if (hasBrowser)
    ...
    private void sendBackResult() {
        if (uciOpts != null) {
            ...
            Intent i = new Intent();
            i.putExtra("com.example.caecuschess.ucioptions", uciMap);
